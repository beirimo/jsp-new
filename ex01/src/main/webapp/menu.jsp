...
<nav class="navbar navbar-expand-lg bg-primary">
	<div class="container-fluid" >
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav mb-2 mb-lg-0"> <!-- 마진엔드-오토 빼기 -->
				...
				<li class="nav-item" id = "myPage" style="display:none;"><a class="nav-link active" aria-current="page" href="/user/mypage">님 어서오세요</a></li><!-- users라고하면 원래 users에 있던거 (/) 가 실행된다. -->
  ...
  <script>  //메뉴에서 로그인 로그아웃 표시해주기 
    const uid ="${uid}"; //세션의 값을 uid에서 꺼내왔다.
